...
import { User as UserIcon, Mail, ShieldCheck, LogOut, Briefcase, Star } from 'lucide-react';
            ...
            {user.memberships && user.memberships.length > 0 ? (
              <ul className="space-y-3">
                {user.memberships.map((membership: UserMembership) => (
                  <li key={membership.businessId} className="p-4 border rounded-lg bg-card shadow-sm">
