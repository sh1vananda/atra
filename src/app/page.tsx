    ...
    <div className="space-y-12">
      <section className="text-center py-10 bg-card rounded-lg shadow-md">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
          Your one-stop platform for digital loyalty cards, exciting rewards, and personalized offers from your favorite businesses. Start earning today!
        </p>
      </section>

      <section>
        <h2 className="text-3xl font-headline font-semibold text-center mb-8 text-foreground">Key Features</h2>
