...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!isAdminAuthenticated) {
      console.log("AdminDashboard:EFFECT[AuthCheck&InitialFetch]: Not authenticated after auth check, redirecting to /login.");
  ...
  console.warn("AdminDashboard:RENDER: Fallback - no suitable render condition met. States:", {adminAuthLoading, isAdminAuthenticated, pageDataLoading, hasFetchedInitialData, managedBusinessExists: !!managedBusiness});
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-150px)]">
      <Loader2 className="h-16 w-16 animate-spin text-primary mb-4" />
